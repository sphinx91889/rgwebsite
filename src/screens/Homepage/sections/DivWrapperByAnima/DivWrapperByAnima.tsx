      ...
      <div className="max-w-[1280px] w-full mx-auto flex flex-col items-center gap-16">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featureCards.map((card) => (
            <div 
              key={card.id}
              className={`rounded-2xl border shadow-sm hover:shadow-md transition-shadow duration-300 ${card.bgClass}`}
            >
        ...
        <Button className="px-8 py-6 bg-[#188bf6] hover:bg-[#0070e0] transition-colors duration-300 rounded-xl font-['Poppins',Helvetica] font-semibold text-white text-lg shadow-md hover:shadow-lg">
          Book a consultation
        </Button>
      </div>
    </section>
